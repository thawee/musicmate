...
public class LocationFound  extends Activity implements ConnectionCallbacks,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(apincer.android.tripmate.R.layout.activity_location_found);
	...
	private void locUI() {
		lblLocation = (TextView) findViewById(apincer.android.tripmate.R.id.lblLocation);
		btnShowLocation = (Button) findViewById(apincer.android.tripmate.R.id.btnShowLocation);
		btnStartLocationUpdates = (Button)findViewById(apincer.android.tripmate.R.id.btnLocationUpdates);
		listButton = (Button) findViewById(apincer.android.tripmate.R.id.listBtn);
	...
	private void togglePeriodicLocationUpdates() {
		if (!mRequestingLocationUpdates) {
			...
			btnStartLocationUpdates
					.setText(getString(apincer.android.tripmate.R.string.btn_stop_location_updates));
			...
			// Changing the button text
			btnStartLocationUpdates
					.setText(getString(apincer.android.tripmate.R.string.btn_start_location_updates));
