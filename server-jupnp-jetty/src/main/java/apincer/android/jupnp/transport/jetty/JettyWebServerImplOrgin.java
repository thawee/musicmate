...
public class JettyWebServerImplOrgin extends BaseServer implements WebServer {
    ...
    public JettyWebServerImplOrgin(Context context, FileRepository fileRepos, TagRepository tagRepos) {
