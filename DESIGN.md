...
- **Minimal Corner Accent Dot Indicator:** Replaced bulky diagonal corner banners (`TriangleLabelView`) over album thumbnails with a subtle 8dp circular Gold dot indicator (`shape_new_dot_indicator.xml`) anchored to the top-right corner of the cover art frame. Keeps album artwork 100% un-obscured while signaling newly added/unmanaged tracks.
