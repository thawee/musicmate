...
import apincer.android.mmate.core.http.NioHttpServer;
import apincer.android.mmate.core.server.IMediaServer;

public class NioUPnpServer extends StreamServerImpl.JUpnpServer {
    /**
    ...
    public NioUPnpServer(Context context, IMediaServer mediaServer, Router router, StreamServerConfigurationImpl configuration) {
    ...
    public void initServer(InetAddress bindAddress) throws Exception {
        ...
        NioHttpServer.Handler upnpHandler = new UpnpHandler(getProtocolFactory());
