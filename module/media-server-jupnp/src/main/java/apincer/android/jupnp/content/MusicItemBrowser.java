...
public class MusicItemBrowser extends AbstractContentBrowser {
    ...
    public MusicItemBrowser(Context context, TagRepository tagRepos,String folderId, String itemPrefix) {
    ...
    public DIDLObject browseMeta(ContentDirectory contentDirectory,
        ...
        MusicTag tag = getOrmLite().findById(StringUtils.toLong(id));
