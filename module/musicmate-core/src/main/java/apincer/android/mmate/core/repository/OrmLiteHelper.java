...
import apincer.android.mmate.core.database.Playlist;
import apincer.android.mmate.core.database.PlaylistItem;
...
public class OrmLiteHelper extends OrmLiteSqliteOpenHelper {
   ...
   /* public static OrmLiteHelper getInstance(Context context) {
    ...
    @Inject
    public OrmLiteHelper(@ApplicationContext Context context) {
