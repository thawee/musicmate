...
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_ALBUM;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_ALBUM_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_COMMENT;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_COMPILATION;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_COMPOSER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_DISC;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_GENRE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_GROUPING;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_PUBLISHER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_QUALITY;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_TITLE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_TRACK;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_AIF_YEAR;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_ALBUM;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_ALBUM_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_COMMENT;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_COMPILATION;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_COMPOSER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_DISC;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_GENRE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_GROUPING;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_ALBUM;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_ALBUM_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_COMMENT;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_DISC;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_GENRE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_TITLE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_TRACK;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP3_YEAR;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_ALBUM;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_ALBUM_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_AUTHOR;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_COMMENT;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_COMPOSER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_GENRE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_GROUPING;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_PUBLISHER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_TITLE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_TRACK;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_MP4_YEAR;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_PUBLISHER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_TITLE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_TRACK;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_ALBUM;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_ALBUM_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_ARTIST;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_COMMENT;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_COMPOSER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_DISC;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_GENRE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_GROUP;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_PUBLISHER;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_QUALITY;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_TITLE;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_TRACK;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_WAVE_YEAR;
import static apincer.android.mmate.core.codec.FFMpegHelper.KEY_TAG_YEAR;
import static apincer.android.mmate.core.codec.FFMpegHelper.METADATA_KEY;
import static apincer.android.mmate.core.utils.TagUtils.isAIFFile;
import static apincer.android.mmate.core.utils.TagUtils.isFLACFile;
import static apincer.android.mmate.core.utils.TagUtils.isMPegFile;
import static apincer.android.mmate.core.utils.TagUtils.isMp4File;
import static apincer.android.mmate.core.utils.TagUtils.isWavFile;
...
import apincer.android.mmate.core.provider.FileSystem;
