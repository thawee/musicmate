...
public class NioContentServerImpl extends AbstractServer {
    ...
    public NioContentServerImpl(Context context, IMediaServer mediaServer) {
    ...
    private NioHttpServer.HttpResponse createSongResponse(MusicTag song, NioHttpServer.HttpRequest request) throws IOException {
        ...
        Log.i(TAG, "Starting stream: \"" + song.getTitle() + "\" [" + formatAudioQuality(song) + "] to " + request.getHeader("host", ""));
        return response;
    }
