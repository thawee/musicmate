...
import static apincer.android.mmate.core.repository.FileRepository.getDefaultMusicPaths;
...
public class TagRepository {
    ...
    public TagRepository(@ApplicationContext Context context, OrmLiteHelper dbHelper) {
