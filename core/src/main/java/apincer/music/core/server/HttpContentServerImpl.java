 ...
 */
public class HttpContentServerImpl extends BaseServer implements ContentServer {
    ...
    public HttpContentServerImpl(Context context, TagRepository repos) {
        super(context);
        this.repos = repos;
    ...
    private class ContentHandler implements HTTPServer.ContextHandler {
        ...
        private void prepareResponseHeaders(HTTPServer.Headers headers, MusicTag tag) {
            ...
            headers.add("Server", getServerSignature(getComponentName()));
