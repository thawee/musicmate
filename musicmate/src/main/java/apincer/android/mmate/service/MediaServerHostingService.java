...
import apincer.android.jupnp.MediaServerImpl;
...
public class MediaServerHostingService extends Service {
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, MusixMateApp.NOTIFICATION_CHANNEL_ID)
                ...
                .setContentText("http://"+mediaServer.getIpAddress()+":"+ WEB_SERVER_PORT);
    ...
    public void onCreate() {
        ...
        this.mediaServer =  new MediaServerImpl(getApplicationContext(), fileRepos, tagRepos); //((MusixMateApp) getApplication()).mediaServer;
