...
public class JettyUPnpServerImpl extends StreamServerImpl.StreamServer {
    ...
    private static final int MAX_THREADS = 12; //50;           // Enough threads for multiple clients
    private static final int MIN_THREADS = 4; //8;            // Keep some threads alive for responsiveness
    ...
    public void initServer(InetAddress bindAddress) throws InitializationException {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                httpConfig.setRequestHeaderSize(4096);
                ...
                try (ServerConnector connector = new ServerConnector(server,
                    ...
                    connector.setAcceptQueueSize(32); // More reasonable queue size
