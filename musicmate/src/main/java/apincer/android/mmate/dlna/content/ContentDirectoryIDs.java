...
public enum ContentDirectoryIDs {
   ...
   /* IMAGES_FOLDER("100999"),
    ...
    MUSIC_FOLDER("0"),
    MUSIC_DIRS_FOLDER("100999"),
    MUSIC_DIR_PREFIX("110999"),
    MUSIC_DIR_ITEM_PREFIX("120999"),
    MUSIC_PLAYLIST_FOLDER("200999"),
    MUSIC_PLAYLIST_PREFIX("210999"),
    MUSIC_PLAYLIST_ITEM_PREFIX("220999"),
