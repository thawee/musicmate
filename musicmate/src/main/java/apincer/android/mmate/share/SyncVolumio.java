...
public class SyncVolumio {
    private final String      host = "volumio.local";
    private final int         port=22;
    private final String      username="volumio";
    private final String      password="volumio";

    private final String      remote_path="/mnt/INTERNAL/";
