...
public class SyncRaspberry {
  //  private final String      host = "mympdos.local"; //""pcp.local";
  //private final String      host = "mpd.local";
    private final String      host = "10.100.1.245";
   // private final String      host = "pcp.local";
  //private final String      host = "moode.local";
   // private final String      host = "smpd.local";
    private final int         port=22;
    private final String      username= "tc"; //"pi"; "tc";
    private final String      password= "piCore"; //piCore";  "raspberry";

    //private final String      remote_path="/mnt/MPD/SD";
    private final String      music_path = "/var/lib/mpd/music/SD"; ///var/lib/mpd/music/INT"; //""/mnt/mmcblk0p3/music";
    ...
    //private final String radio_thumb_path = "/var/lib/mympd/pics/thumbs";
    //private final String      remote_path="/data/library/";
    //private final String      remote_path="/media/mmcblk0p2/library/"; //""/mnt/mmcblk0p2/library";
   // private final String      remote_path="/var/lib/mpd/music/INTERNAL";
