...
import apincer.android.mmate.utils.CollectionHelper;
...
public enum ContentGroup {
    ...
    DOCUMENT("6-docs", "doc-", "Documents");

    private static final Collection<String> IDS = Collections.unmodifiableCollection(
            CollectionHelper.map(values(), new CollectionHelper.Function<ContentGroup, String>() {
                @Override
