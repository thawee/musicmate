...
public class ContentNode extends AbstractContent {
    ...
    public ContentNode (final String id, final String parentId, final String title, final File dir,  final String sortKey, final Collection<ContentItem> itemsCollection) {
