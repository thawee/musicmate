...
import apincer.android.jupnp.JupnpMediaServerImpl;
import apincer.android.jupnp.MediaServerConfiguration;
...
public class MediaServerHostingService extends Service {
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, MusixMateApp.NOTIFICATION_CHANNEL_ID)
                ...
                .setContentText("http://"+mediaServer.getIpAddress()+":"+ MediaServerConfiguration.WEB_SERVER_PORT);
    ...
    public void onCreate() {
        ...
        this.mediaServer =  new JupnpMediaServerImpl(getApplicationContext()); //((MusixMateApp) getApplication()).mediaServer;
