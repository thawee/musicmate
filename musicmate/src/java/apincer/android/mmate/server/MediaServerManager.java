...
import apincer.android.server.IMediaServer;
...
public class MediaServerManager {
    ...
    private final MutableLiveData<IMediaServer.ServerStatus> serverStatusLiveData = new MutableLiveData<>();
    ...
    public LiveData<IMediaServer.ServerStatus> getServerStatus() {
    ...
    public void startServer() {
        ...
        try {
            ...
            serverStatusLiveData.setValue(IMediaServer.ServerStatus.ERROR); // Reflect error immediately
        }
    }
    ...
    public String getServerLocation() {
        return "http://"+mediaServer.getIpAddress()+":"+ mediaServer.getWebUIPort();
    }
}
