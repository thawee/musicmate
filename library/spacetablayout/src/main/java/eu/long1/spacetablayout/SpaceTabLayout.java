...
public class SpaceTabLayout extends RelativeLayout {
    ...
    public void initialize(ViewPager viewPager, FragmentManager fragmentManager, List<Fragment> fragments) {
		...
		if (numberOfTabs <= 3 && !iconOnly) {
            ...
            if (numberOfTabs > 2) tabThree.setCustomView(R.layout.icon_text_tab_layout);
            ...
            if (numberOfTabs > 2) tabThreeTextView = (TextView) tabThree.getCustomView().findViewById(R.id.tabTextView);
            ...
            if (numberOfTabs > 2) tabThreeImageView = (ImageView) tabThree.getCustomView().findViewById(R.id.tabImageView);
    ...
    private void setAttrs() {
        ...
        if (numberOfTabs <= 3 && !iconOnly) {
            ...
            if (numberOfTabs > 2 && text_three != null) setTabThreeText(text_three);

            setTabOneTextColor(defaultTextColor);
            setTabTwoTextColor(defaultTextColor);
            if (numberOfTabs > 2) setTabThreeTextColor(defaultTextColor);
        }
